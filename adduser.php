...
if(isset($_POST)) {
	...
	if($uploadOk == false) {
		...
		$sql = "INSERT INTO users(firstname, lastname, email, password, address, city, state, contactno, stream, passingyear, dob, age, resume) VALUES ('$firstname', '$lastname', '$email', '$password', '$address', '$city', '$state', '$contactno', '$stream', '$passingyear', '$dob', '$age', '$file')";
		if($conn->query($sql)===TRUE) {
			// Send Email
			// $to = $email;
			 //$subject = "Campus placement - Confirm Your Email Address";
			 //$message = '
			...
			// 	<title>Confirm Your Email</title>
			 //<body>
				...
				//<a href="campusPlacement.com/verify.php?token='.$hash.'&email='.$email.'">Verify Email</a>
			 //</body>
			 //</html>
			//';
			 ...
			 //$headers[] = 'To: '.$to;
			 //$headers[] = 'From: yashshreerasal1@gmail.com';
